            ...
            <div class="col-md-8">
                <div class="contact-form">
                    ...
                    <form action="#" method="post">
                        <input style="width: 500px; font-family:montserrat; margin-top: 5px;" type="text" name="name" required placeholder="Name" class="box" onkeydown="return /[a-z, ]/i.test(event.key)" id="firstname" name="firstname">

                        <input style="width: 500px; font-family:montserrat;" type="email" name="email" required placeholder="Email" class="box">
