...
try {
    ...
    $mail->Subject = 'Verification code for creating a new password';
    $mail->Body = "Dear " . "$firstname " . "$lastname,<br><br>" .

        "We have received a request to change your password on your SearchSerpent account. To complete this process, please use the verification code below: <br><br>" .

        "Verification code: " . "<b>$vercode</b> <br><br>" .

        "Please enter this code on the forgot password page to confirm your identity and create a new password. If you did not request this change, please contact our support team immediately at leitechcorp@gmail.com so we can assist you.<br><br>" .

        "Thank you for choosing SearchSerpent.<br><br>" .
