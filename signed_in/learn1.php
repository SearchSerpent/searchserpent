...
<body>
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active">Learn / Programming Languages</li>
        </ul>
    </div>
        ...
        <div class="container">
            <div class="table">
                <div class="col-md-4 col-sm-4">
                    <div class="block">
                        <div class="cost">
                            <img src="images/learn/learn1/coding-language.jpg" style="width: 300px; height: 200px;" alt="" />
                            <h3>Coding <br> Languages</h3>

                            <p>www.bestcolleges.com</p>
                        </div>

                        <div class="info">
                            <ul class="item-list">
                                <li>Discover the best coding language to learn for a variety of applications. 
                                    Choose the right coding languages to launch your programming career.
                                    <br>
                                    <br>
                                </li>
                                <li><a style="color:darkgray; text-decoration: none;" href="https://www.bestcolleges.com/computer-science/coding-language-types/" target="_blank"><button type="button">View</button></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
